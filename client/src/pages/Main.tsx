...
function MainFirstSection() {
  return (
    ...
    >
      <div className="text-left p-32 pt-44 transition-all">
        <p className="text-4xl">물건을 빌리는 가장 쉬운 방법</p>
        <p className="text-7xl">초간편 물품 대여 중계 플랫폼</p>
        <p className="text-7xl text-amber-500	">빌리지</p>
      </div>
    </section>
  );
}
  ...
  return (
    <section className="w-screen h-screen">
      ...
      <div>
        ...
        <div>
          step 2. 물품을 빌려가실 때, 상대방에게 바로 대화를 걸어보세요!
        </div>
        <div>
          step 3. 물품을 빌려가실 때, 대여기간을 설정한 후 대여 요청을
          보내주세요!
        </div>
